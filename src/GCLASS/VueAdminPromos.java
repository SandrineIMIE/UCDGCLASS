...
public class VueAdminPromos extends JFrame {
		...
		protected JMenu comptes = new JMenu("Comptes >");
		...
		public VueAdminPromos(){
			...
			barreMenu.add(comptes);
			barreMenu.add(nomuser);
			
			container.setLayout(new BorderLayout());
			
			JComboBox box1 = new JComboBox<>();
			box1.addItem(" Promo numero 1, imie le mans");
			box1.addItem(" Promo numero 2, imie le mans");
			box1.addItem(" Promo numero 3, imie le mans");
